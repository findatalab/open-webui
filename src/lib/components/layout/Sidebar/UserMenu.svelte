...
<DropdownMenu.Root bind:open={show} onOpenChange={handleDropdownChange}>
	...
	<slot name="content">
		<DropdownMenu.Content
			class="w-full {className}  rounded-2xl px-1 py-1  border border-gray-100  dark:border-gray-800 z-50 bg-white dark:bg-gray-850 text-gray-700 dark:text-gray-100 shadow-lg text-sm"
			sideOffset={4}
			side="top"
			{align}
